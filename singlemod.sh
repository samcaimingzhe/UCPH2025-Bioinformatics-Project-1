dorado download --model rna004_130bps_sup@v5.3.0_m6A@v1 --models-directory ~/drdmodel/
dorado download --model rna004_130bps_sup@v5.3.0_inosine_m6A_2OmeA@v1   --models-directory ~/drdmodel/
...
pod5 convert to_fast5 /projects/renlab/data/projects/projects_with_PB/AMV/nanopore_data/CONTROL_COLD_COL0MOCK/*/*/pod5/ --output fast5_dir/
...
{
info=(${file//// })
f5c eventalign -r basecall_output_dir/CONTROL_COLD_COL0MOCK.fastq -b $file -g ref3.fa -t 15 --pore rna004 --rna --scale-events --samples --signal-index --summary eventalign_output_dir/${info[-1]%%.bam}_summary.txt --print-read-names > eventalign_output_dir/${info[-1]%%.bam}_eventalign.txt
} &
done
